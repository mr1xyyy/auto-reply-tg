...
def register_activity_handlers(client, events) -> None:
    """Register activity-tracking handlers with compatibility fallback."""
    ...
    # Some Telethon builds differ in MessageRead behavior; keep startup resilient.
    try:
        ...
        logging.warning("MessageRead activity handler disabled: %s", exc)
